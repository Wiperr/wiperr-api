 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Bookings/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Booking.payment() instead.
            "prototype$__get__payment": {
              url: urlBase + "/Bookings/:id/payment",
              method: "GET",
            },

            // INTERNAL. Use Booking.payment.create() instead.
            "prototype$__create__payment": {
              url: urlBase + "/Bookings/:id/payment",
              method: "POST",
            },

            // INTERNAL. Use Booking.payment.update() instead.
            "prototype$__update__payment": {
              url: urlBase + "/Bookings/:id/payment",
              method: "PUT",
            },

            // INTERNAL. Use Booking.payment.destroy() instead.
            "prototype$__destroy__payment": {
              url: urlBase + "/Bookings/:id/payment",
              method: "DELETE",
            },

            // INTERNAL. Use Booking.coupon() instead.
            "prototype$__get__coupon": {
              url: urlBase + "/Bookings/:id/coupon",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Booking#prototype$patchAttributes
             * @methodOf lbServices.Booking
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Booking#updateAttributes
             * @methodOf lbServices.Booking
             *
             * @description
             *
    ...
    /**
     * @ngdoc object
     * @name lbServices.Booking.payment
     * @header lbServices.Booking.payment
     * @object
     * @description
     *
     * The object `Booking.payment` groups methods
     * manipulating `Payment` instances related to `Booking`.
     *
     * Call {@link lbServices.Booking#payment Booking.payment()}
     ...
     */
             ...
             * @description
             *
             * Fetches hasOne relation payment.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Booking id
        ...
        R.payment = function() {
          ...
          var action = TargetResource["::get::Booking::payment"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Booking.payment#create
             * @methodOf lbServices.Booking.payment
             *
             * @description
             *
        ...
        R.payment.create = function() {
          var TargetResource = $injector.get("Payment");
          var action = TargetResource["::create::Booking::payment"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Booking.payment#createMany
             * @methodOf lbServices.Booking.payment
             *
             * @description
             *
        ...
        R.payment.createMany = function() {
          var TargetResource = $injector.get("Payment");
          var action = TargetResource["::createMany::Booking::payment"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Booking.payment#destroy
             * @methodOf lbServices.Booking.payment
             *
             * @description
             *
             * Deletes payment of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Booking id
             ...
             */
        R.payment.destroy = function() {
          var TargetResource = $injector.get("Payment");
          var action = TargetResource["::destroy::Booking::payment"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Booking.payment#update
             * @methodOf lbServices.Booking.payment
             *
             * @description
             *
             * Update payment of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Booking id
             ...
             * </em>
             */
        R.payment.update = function() {
          var TargetResource = $injector.get("Payment");
          var action = TargetResource["::update::Booking::payment"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Booking#coupon
             * @methodOf lbServices.Booking
             *
             * @description
             *
        ...
        R.coupon = function() {
          ...
          var action = TargetResource["::get::Booking::coupon"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Services/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Service#prototype$patchAttributes
             * @methodOf lbServices.Service
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Service#updateAttributes
             * @methodOf lbServices.Service
             *
             * @description
             *
...
/**
 * @ngdoc object
 * @name lbServices.MailingList
 * @header lbServices.MailingList
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `MailingList` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/MailingLists/:id",
          { 'id': '@id' },
          {

            /**
             * @ngdoc method
             * @name lbServices.MailingList#create
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             */
            "create": {
              url: urlBase + "/MailingLists",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#createMany
             * @methodOf lbServices.MailingList
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#patchOrCreate
             * @methodOf lbServices.MailingList
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#replaceOrCreate
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/MailingLists/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#upsertWithWhere
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/MailingLists/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#exists
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/MailingLists/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#findById
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/MailingLists/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#replaceById
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/MailingLists/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#find
             * @methodOf lbServices.MailingList
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#findOne
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/MailingLists/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#updateAll
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/MailingLists/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#deleteById
             * @methodOf lbServices.MailingList
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#count
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/MailingLists/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.MailingList#prototype$patchAttributes
             * @methodOf lbServices.MailingList
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#createChangeStream
             * @methodOf lbServices.MailingList
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/MailingLists/change-stream",
              method: "POST",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#upsert
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#updateOrCreate
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#patchOrCreateWithWhere
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#update
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#destroyById
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#removeById
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.MailingList#updateAttributes
             * @methodOf lbServices.MailingList
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.MailingList#modelName
        * @propertyOf lbServices.MailingList
        * @description
        * The name of the model represented by this $resource,
        * i.e. `MailingList`.
        */
        R.modelName = "MailingList";
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Payments/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Booking.payment.createMany() instead.
            "::createMany::Booking::payment": {
              isArray: true,
              url: urlBase + "/Bookings/:id/payment",
              method: "POST",
            },
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Payment#updateAttributes
             * @methodOf lbServices.Payment
             *
             * @description
             *
...
/**
 * @ngdoc object
 * @name lbServices.CallRequest
 * @header lbServices.CallRequest
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `CallRequest` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/CallRequests/:id",
          { 'id': '@id' },
          {

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#create
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `CallRequest` object.)
             * </em>
             */
            "create": {
              url: urlBase + "/CallRequests",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#createMany
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#patchOrCreate
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#replaceOrCreate
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/CallRequests/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#upsertWithWhere
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/CallRequests/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#exists
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/CallRequests/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#findById
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/CallRequests/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#replaceById
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/CallRequests/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#find
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#findOne
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/CallRequests/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#updateAll
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/CallRequests/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#deleteById
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#count
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/CallRequests/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CallRequest#prototype$patchAttributes
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#createChangeStream
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/CallRequests/change-stream",
              method: "POST",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#upsert
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#updateOrCreate
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#patchOrCreateWithWhere
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#update
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#destroyById
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#removeById
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.CallRequest#updateAttributes
             * @methodOf lbServices.CallRequest
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.CallRequest#modelName
        * @propertyOf lbServices.CallRequest
        * @description
        * The name of the model represented by this $resource,
        * i.e. `CallRequest`.
        */
        R.modelName = "CallRequest";
...
/**
 * @ngdoc object
 * @name lbServices.Credential
 * @header lbServices.Credential
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Credential` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        var R = LoopBackResource(
        urlBase + "/Credentials/:id",
          { 'id': '@id' },
          {

            /**
             * @ngdoc method
             * @name lbServices.Credential#create
             * @methodOf lbServices.Credential
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Credential` object.)
             * </em>
             */
            "create": {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#createMany
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#patchOrCreate
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#replaceOrCreate
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Credentials/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#upsertWithWhere
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/Credentials/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#exists
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/Credentials/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#findById
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#replaceById
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/Credentials/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#find
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#findOne
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/Credentials/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#updateAll
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/Credentials/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#deleteById
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#count
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/Credentials/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Credential#prototype$patchAttributes
             * @methodOf lbServices.Credential
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#createChangeStream
             * @methodOf lbServices.Credential
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/Credentials/change-stream",
              method: "POST",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#upsert
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#updateOrCreate
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#patchOrCreateWithWhere
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#update
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#destroyById
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#removeById
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Credential#updateAttributes
             * @methodOf lbServices.Credential
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Credential#modelName
        * @propertyOf lbServices.Credential
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Credential`.
        */
        R.modelName = "Credential";
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Clients/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Client#getUser
             * @methodOf lbServices.Client
             *
             * @description
             *
